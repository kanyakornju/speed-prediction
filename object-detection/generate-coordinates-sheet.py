...
category_label = ['empty','car', 'zebra crossing', 'human', 'bus stop']
...
def export_excel_sheet(data_dict):
    workbook = xlsxwriter.Workbook('Object-Coordinates.xlsx') # name of the Excel sheet
...
path=f"/content/vehicle-distance-estimation/object-detector/runs/detect/exp/labels"
